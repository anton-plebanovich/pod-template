...
swift_files_in_project=$(sed -n '/Begin PBXSourcesBuildPhase/,/End PBXSourcesBuildPhase section/p;/End PBXSourcesBuildPhase/q' 'Carthage Project/${POD_NAME}.xcodeproj/project.pbxproj' | sed -n '/files =/,/);/p' | sed '1d;$d' | grep -o "[A-Z].[0-9a-zA-Z+ ]*\.swift" | sort -fu)
